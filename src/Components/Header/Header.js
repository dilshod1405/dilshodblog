      ...
      <div className='header'>
        ...
        <a href={'/'} style={{height: '5px'}}><h5 style={{color: element.text, height: '15px'}}>{this.props.header('banner.logo')}</h5></a>
            ...
            <ul className='icons'>    
                ...
                <li><button className='btn'><a href={'https://t.me/dilshodblog_1405'}><i className="fa-brands fa-telegram fa-lg" style={{color: element.text}}></i></a></button></li>
                <li><button className='btn'><a href={'https://wa.me/+998937041405?text=<message_text>'}><i className="fa-brands fa-whatsapp fa-lg" style={{color: element.text}}></i></a></button></li>
